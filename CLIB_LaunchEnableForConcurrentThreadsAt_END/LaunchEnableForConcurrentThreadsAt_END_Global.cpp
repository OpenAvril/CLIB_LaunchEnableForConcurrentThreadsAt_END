...
void OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtEND::LaunchEnableForConcurrentThreadsAt_END_Global::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_STACK_Global()
{
...
unsigned char* OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtEND::LaunchEnableForConcurrentThreadsAt_END_Global::stat_CONVERT_bool_to_ByteArray(bool bool_Value)
{
...
bool OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtEND::LaunchEnableForConcurrentThreadsAt_END_Global::stat_CONVERT_ByteArray_To_bool(unsigned char* bytes)
{
    return bytes[1] != 0; 
}
