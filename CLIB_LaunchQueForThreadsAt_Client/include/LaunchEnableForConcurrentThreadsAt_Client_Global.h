#ifndef CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_GLOBAL_H
#define CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_GLOBAL_H
#include <array>
