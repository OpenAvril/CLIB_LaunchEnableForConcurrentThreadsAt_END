#ifndef CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_CONTROL_H
#define CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_LAUNCHENABLEFORCONCURRENTTHREADSAT_Client_CONTROL_H
#include <cstdint>
#include <list>
namespace CLIBLaunchQueAtClient
{
    ...
    public:
        ...
        void app_launchEnable_Activate(LaunchEnableForConcurrentThreadsAt_Client_Framework* obj);
        void app_launchEnable_Request(LaunchEnableForConcurrentThreadsAt_Client_Framework* obj, uint8_t concurrentThreadID);
        void app_launchEnable_SortQue(LaunchEnableForConcurrentThreadsAt_Client_Framework* obj, uint8_t number_Implemented_Threads);
        void app_launchQue_Update(LaunchEnableForConcurrentThreadsAt_Client_Framework* obj, uint8_t number_Implemented_Threads);
