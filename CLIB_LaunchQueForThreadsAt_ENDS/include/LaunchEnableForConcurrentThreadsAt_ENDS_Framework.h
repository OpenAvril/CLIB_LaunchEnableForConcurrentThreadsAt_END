...
namespace CLIBLaunchQueAtENDS {
    ...
    public:
        ...
        void dyn_CLASS_create_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global_and_Settings();
        class LaunchEnableForConcurrentThreadsAt_ENDS_App* dyn_CLASS_get_ptr_LaunchEnableForConcurrentThreadsAt_ENDS_App();
        class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global* dyn_CLASS_get_ptr_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global();
        ...
        static void stat_CLASS_boot3_INITIALISE_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global();
    ...
    private:
        ...
        static void stat_CLASS_boot1_DEFINE_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global();
        static void stat_CLASS_boot3_INITIALISE_LaunchEnableForConcurrentThreadsAt_ENDS_App();
        static void pr_stat_CLASS_boot3_INITIALISE_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global();
        static class LaunchEnableForConcurrentThreadsAt_ENDS_App* stat_CLASS_get_ptr_LaunchEnableForConcurrentThreadsAt_ENDS_App();
        static class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global* stat_CLASS_get_ptr_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Global();
    };
};
#endif