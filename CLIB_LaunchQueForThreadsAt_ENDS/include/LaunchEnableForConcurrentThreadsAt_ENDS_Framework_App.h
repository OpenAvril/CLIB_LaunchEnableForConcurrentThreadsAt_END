...
namespace CLIBLaunchQueAtENDS {
    ...
    public:
        ...
        class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_App_Control* dyn_CLASS_get_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_App_Control();
        class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Execute* dyn_CLASS_get_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Execute();
    ...
    private:
        ...
        static class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Execute* _stat_CLASS_LaunchEnableForConcurrentThreadsAt_ENDS_App_Ececute;
        ...
        static class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_App_Control* stat_CLASS_get_LaunchEnableForConcurrentThreadsAt_ENDS_App_WriteEnable_Control();
        static class LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Execute* stat_CLASS_get_LaunchEnableForConcurrentThreadsAt_ENDS_Framework_Execute();
    };
}
#endif