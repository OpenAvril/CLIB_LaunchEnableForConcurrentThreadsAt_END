...
// public.
    ...
    void CLIBLaunchQueAtEND::LaunchEnableForConcurrentThreadsAt_END__App::dyn_APP_FUNCT_LaunchEnableForConcurrentThreadsAt_END__thread_Start(LaunchEnableForConcurrentThreadsAt_END__Framework* obj, uint8_t concurrentThreadID) {
        CLIBWriteQueAtServerLaunchQue_ConditionCode::CLIB_WriteEnableForThreadsAt_END_LaunchQueConditionCode::CLIB_WriteEnableForThreadsAt_ServerLaunchQue_ConditionCode__App_FUNCT_write_Start(LaunchEnableForConcurrentThreadsAt_END__Global::stat_CONVERT_LaunchEnableForConcurrentThreadsAt_END__Global__uint8_t_To_ByteArray(concurrentThreadID));
        ...
        CLIBWriteQueAtServerLaunchQue_ConditionCode::CLIB_WriteEnableForThreadsAt_END_LaunchQueConditionCode::CLIB_WriteEnableForThreadsAt_ServerLaunchQue_ConditionCode__App_FUNCT_write_End(LaunchEnableForConcurrentThreadsAt_END__Global::stat_CONVERT_LaunchEnableForConcurrentThreadsAt_END__Global__uint8_t_To_ByteArray(concurrentThreadID));
    }
