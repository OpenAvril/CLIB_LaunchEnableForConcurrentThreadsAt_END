#ifndef CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_CONTROL_H
#define CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_CONTROL_H
#include <cstdint>
#include <list>
namespace CLIBLaunchQueAtEND
{
    ...
    public:
        ...
        void app_launchEnable_Activate(LaunchEnableForConcurrentThreadsAt_END_Framework* obj);
        void app_launchEnable_Request(LaunchEnableForConcurrentThreadsAt_END_Framework* obj, uint8_t concurrentThreadID);
        void app_launchEnable_SortQue(LaunchEnableForConcurrentThreadsAt_END_Framework* obj, uint8_t number_Implemented_Threads);
        void app_launchQue_Update(LaunchEnableForConcurrentThreadsAt_END_Framework* obj, uint8_t number_Implemented_Threads);
