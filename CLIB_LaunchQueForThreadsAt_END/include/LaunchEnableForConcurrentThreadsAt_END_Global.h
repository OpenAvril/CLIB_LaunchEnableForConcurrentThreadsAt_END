#ifndef CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_GLOBAL_H
#define CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_GLOBAL_H
#include <array>
