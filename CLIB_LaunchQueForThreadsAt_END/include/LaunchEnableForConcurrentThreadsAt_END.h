#ifndef CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_H
#define CLIB_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_LAUNCHENABLEFORCONCURRENTTHREADSAT_END_H
#include <cstdint>
namespace CLIBLaunchQueAtEND
{
    ...
    public:
        ...
        static void boot0_CLASS_DECLARE_LaunchEnableForConcurrentThreadsAt_END();
        ...
        static void boot0_REG_DECLARE_LaunchEnableForConcurrentThreadsAt_END();
        ...
        void boot4_PGM_INSTANTIATION_LaunchEnableForConcurrentThreadsAt_END();
    ...
    private:
        ...
        static LaunchEnableForConcurrentThreadsAt_END_Global* stat_CLASS_get_ptr_Global();
        static LaunchEnableForConcurrentThreadsAt_END_Control* stat_CLASS_get_ptr_LaunchConcurrency_Control();
    };
}
#endif